...
theorem released_global_eta_level7_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR3 7 = releasedGlobalEtaWeightedLevel7NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level7_weighted_nats_r3
