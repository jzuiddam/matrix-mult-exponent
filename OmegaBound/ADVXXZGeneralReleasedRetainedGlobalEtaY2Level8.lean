...
theorem released_global_eta_level8_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR2 8 = releasedGlobalEtaWeightedLevel8NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level8_weighted_nats_r2
