...
theorem released_global_lambda_level1_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR1 1 = releasedGlobalLambdaWeightedLevel1NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level1_weighted_nats_r1
