...
theorem released_global_eta_level7_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR1 7 = releasedGlobalEtaWeightedLevel7NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level7_weighted_nats_r1
