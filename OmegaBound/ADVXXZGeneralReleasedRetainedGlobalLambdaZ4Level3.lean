...
theorem released_global_lambda_level3_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR4 3 = releasedGlobalLambdaWeightedLevel3NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level3_weighted_nats_r4
