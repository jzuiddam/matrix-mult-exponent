...
theorem released_global_eta_level4_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR1 4 = releasedGlobalEtaWeightedLevel4NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level4_weighted_nats_r1
