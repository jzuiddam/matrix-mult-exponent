import OmegaBound.ADVXXZGeneralReleasedRetainedGlobalLambdaZ1Data
...
theorem released_global_lambda_direct_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalLambdaDirectRowsR1 = releasedGlobalLambdaWeightedDirectNatsR1 := by
  classical
  unfold releasedGlobalLambdaDirectRowsR1 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalLambdaWeightedDirectNatsR1
  ...
  simp (config := { maxSteps := 10000000 }) only [
    ...
    OmegaBound.ADVXXZR1CertificateSplitData.certificateSplitByIndex]
  simp
  all_goals norm_lambda_z1_rows
  all_goals ring

end OmegaBound.ADVXXZGeneral

#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_direct_weighted_nats_r1
