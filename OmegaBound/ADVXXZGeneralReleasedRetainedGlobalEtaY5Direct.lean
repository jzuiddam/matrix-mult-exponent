import OmegaBound.ADVXXZGeneralReleasedRetainedGlobalEtaY5Data
...
theorem released_global_eta_direct_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalEtaDirectRowsR5 = releasedGlobalEtaWeightedDirectNatsR5 := by
  classical
  unfold releasedGlobalEtaDirectRowsR5 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalEtaWeightedDirectNatsR5
  ...
  simp
  all_goals norm_eta_y5_rows
  all_goals ring

end OmegaBound.ADVXXZGeneral

#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_direct_weighted_nats_r5
