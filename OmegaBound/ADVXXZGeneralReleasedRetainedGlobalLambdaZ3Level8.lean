...
theorem released_global_lambda_level8_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR3 8 = releasedGlobalLambdaWeightedLevel8NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level8_weighted_nats_r3
