...
theorem released_global_lambda_level2_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR0 2 = releasedGlobalLambdaWeightedLevel2NatsR0 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level2_weighted_nats_r0
