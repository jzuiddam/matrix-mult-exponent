...
theorem released_global_eta_level4_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR3 4 = releasedGlobalEtaWeightedLevel4NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level4_weighted_nats_r3
