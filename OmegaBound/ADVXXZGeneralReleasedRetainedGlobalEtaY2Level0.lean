...
theorem released_global_eta_level0_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR2 0 = releasedGlobalEtaWeightedLevel0NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level0_weighted_nats_r2
