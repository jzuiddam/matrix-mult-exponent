...
theorem released_global_lambda_level1_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR0 1 = releasedGlobalLambdaWeightedLevel1NatsR0 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level1_weighted_nats_r0
