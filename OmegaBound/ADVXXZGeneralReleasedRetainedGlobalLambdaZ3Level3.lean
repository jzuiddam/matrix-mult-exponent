...
theorem released_global_lambda_level3_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR3 3 = releasedGlobalLambdaWeightedLevel3NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level3_weighted_nats_r3
