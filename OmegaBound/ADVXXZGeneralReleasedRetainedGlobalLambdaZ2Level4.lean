...
theorem released_global_lambda_level4_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR2 4 = releasedGlobalLambdaWeightedLevel4NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level4_weighted_nats_r2
