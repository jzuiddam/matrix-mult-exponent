...
theorem released_global_eta_level3_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR4 3 = releasedGlobalEtaWeightedLevel3NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level3_weighted_nats_r4
