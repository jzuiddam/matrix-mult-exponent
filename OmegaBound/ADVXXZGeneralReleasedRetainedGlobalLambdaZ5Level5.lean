...
theorem released_global_lambda_level5_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR5 5 = releasedGlobalLambdaWeightedLevel5NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level5_weighted_nats_r5
