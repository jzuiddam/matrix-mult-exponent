...
theorem released_global_eta_level0_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR5 0 = releasedGlobalEtaWeightedLevel0NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level0_weighted_nats_r5
