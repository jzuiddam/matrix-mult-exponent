...
theorem released_global_eta_level2_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR3 2 = releasedGlobalEtaWeightedLevel2NatsR3 := by
  classical
  unfold releasedGlobalEtaMixRowsR3 releasedLogicalAlphaYZ releasedLogicalBetaYZ
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level2_weighted_nats_r3
