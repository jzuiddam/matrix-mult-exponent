...
theorem released_global_eta_level3_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR2 3 = releasedGlobalEtaWeightedLevel3NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level3_weighted_nats_r2
