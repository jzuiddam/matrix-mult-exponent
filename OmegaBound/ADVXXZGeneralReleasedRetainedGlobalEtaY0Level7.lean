...
theorem released_global_eta_level7_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR0 7 = releasedGlobalEtaWeightedLevel7NatsR0 := by
  classical
  unfold releasedGlobalEtaMixRowsR0 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalEtaWeightedLevel7NatsR0
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level7_weighted_nats_r0
