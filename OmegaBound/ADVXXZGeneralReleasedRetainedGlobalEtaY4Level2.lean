...
theorem released_global_eta_level2_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR4 2 = releasedGlobalEtaWeightedLevel2NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level2_weighted_nats_r4
