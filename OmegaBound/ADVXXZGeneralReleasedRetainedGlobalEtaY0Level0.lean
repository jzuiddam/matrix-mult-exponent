...
theorem released_global_eta_level0_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR0 0 = releasedGlobalEtaWeightedLevel0NatsR0 := by
  classical
  unfold releasedGlobalEtaMixRowsR0 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalEtaWeightedLevel0NatsR0
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level0_weighted_nats_r0
