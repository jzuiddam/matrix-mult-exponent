...
theorem released_global_lambda_level0_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR2 0 = releasedGlobalLambdaWeightedLevel0NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level0_weighted_nats_r2
