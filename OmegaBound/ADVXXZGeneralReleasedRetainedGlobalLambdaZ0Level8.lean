...
theorem released_global_lambda_level8_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR0 8 = releasedGlobalLambdaWeightedLevel8NatsR0 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level8_weighted_nats_r0
