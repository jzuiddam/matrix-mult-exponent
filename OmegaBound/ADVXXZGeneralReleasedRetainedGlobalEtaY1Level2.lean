...
theorem released_global_eta_level2_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR1 2 = releasedGlobalEtaWeightedLevel2NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level2_weighted_nats_r1
