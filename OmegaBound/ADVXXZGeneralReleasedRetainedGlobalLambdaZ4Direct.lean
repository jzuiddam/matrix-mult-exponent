import OmegaBound.ADVXXZGeneralReleasedRetainedGlobalLambdaZ4Data
...
theorem released_global_lambda_direct_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalLambdaDirectRowsR4 = releasedGlobalLambdaWeightedDirectNatsR4 := by
  classical
  unfold releasedGlobalLambdaDirectRowsR4 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalLambdaWeightedDirectNatsR4
  ...
  simp
  all_goals norm_lambda_z4_rows
  all_goals ring

end OmegaBound.ADVXXZGeneral

#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_direct_weighted_nats_r4
