...
theorem released_global_lambda_level6_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR4 6 = releasedGlobalLambdaWeightedLevel6NatsR4 := by
  classical
  unfold releasedGlobalLambdaMixRowsR4 releasedLogicalAlphaYZ releasedLogicalBetaYZ
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level6_weighted_nats_r4
