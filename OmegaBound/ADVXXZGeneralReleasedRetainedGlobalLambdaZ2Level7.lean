...
theorem released_global_lambda_level7_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR2 7 = releasedGlobalLambdaWeightedLevel7NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level7_weighted_nats_r2
