...
theorem released_global_eta_level3_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR0 3 = releasedGlobalEtaWeightedLevel3NatsR0 := by
  classical
  unfold releasedGlobalEtaMixRowsR0 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalEtaWeightedLevel3NatsR0
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level3_weighted_nats_r0
