...
theorem released_global_lambda_level2_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR2 2 = releasedGlobalLambdaWeightedLevel2NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level2_weighted_nats_r2
