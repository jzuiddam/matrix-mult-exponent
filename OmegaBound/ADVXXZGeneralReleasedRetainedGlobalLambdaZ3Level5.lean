...
theorem released_global_lambda_level5_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR3 5 = releasedGlobalLambdaWeightedLevel5NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level5_weighted_nats_r3
