...
theorem released_global_eta_level4_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR0 4 = releasedGlobalEtaWeightedLevel4NatsR0 := by
  classical
  unfold releasedGlobalEtaMixRowsR0 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalEtaWeightedLevel4NatsR0
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level4_weighted_nats_r0
