...
theorem released_global_lambda_level5_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR1 5 = releasedGlobalLambdaWeightedLevel5NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level5_weighted_nats_r1
