...
theorem released_global_eta_level5_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR1 5 = releasedGlobalEtaWeightedLevel5NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level5_weighted_nats_r1
