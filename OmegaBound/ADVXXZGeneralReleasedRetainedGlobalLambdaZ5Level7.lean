...
theorem released_global_lambda_level7_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR5 7 = releasedGlobalLambdaWeightedLevel7NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level7_weighted_nats_r5
