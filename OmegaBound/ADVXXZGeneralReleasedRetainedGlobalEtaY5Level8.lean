...
theorem released_global_eta_level8_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR5 8 = releasedGlobalEtaWeightedLevel8NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level8_weighted_nats_r5
