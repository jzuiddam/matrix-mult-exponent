...
theorem released_global_eta_level8_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR0 8 = releasedGlobalEtaWeightedLevel8NatsR0 := by
  classical
  unfold releasedGlobalEtaMixRowsR0 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalEtaWeightedLevel8NatsR0
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level8_weighted_nats_r0
