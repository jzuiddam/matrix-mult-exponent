...
theorem released_global_lambda_level0_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR1 0 = releasedGlobalLambdaWeightedLevel0NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level0_weighted_nats_r1
