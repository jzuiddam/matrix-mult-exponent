...
theorem released_global_eta_level5_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR2 5 = releasedGlobalEtaWeightedLevel5NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level5_weighted_nats_r2
