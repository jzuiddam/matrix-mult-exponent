...
theorem released_global_eta_level8_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR4 8 = releasedGlobalEtaWeightedLevel8NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level8_weighted_nats_r4
