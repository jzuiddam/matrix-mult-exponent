...
theorem released_global_eta_level6_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR1 6 = releasedGlobalEtaWeightedLevel6NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level6_weighted_nats_r1
