...
theorem released_global_lambda_level4_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR4 4 = releasedGlobalLambdaWeightedLevel4NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level4_weighted_nats_r4
