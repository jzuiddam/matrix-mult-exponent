...
theorem released_global_lambda_level7_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR1 7 = releasedGlobalLambdaWeightedLevel7NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level7_weighted_nats_r1
