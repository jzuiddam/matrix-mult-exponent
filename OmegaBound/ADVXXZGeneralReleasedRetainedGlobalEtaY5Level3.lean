...
theorem released_global_eta_level3_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR5 3 = releasedGlobalEtaWeightedLevel3NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level3_weighted_nats_r5
