...
theorem released_global_eta_level8_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR3 8 = releasedGlobalEtaWeightedLevel8NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level8_weighted_nats_r3
