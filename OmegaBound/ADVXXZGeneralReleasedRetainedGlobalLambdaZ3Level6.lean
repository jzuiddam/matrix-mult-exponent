...
theorem released_global_lambda_level6_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR3 6 = releasedGlobalLambdaWeightedLevel6NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level6_weighted_nats_r3
