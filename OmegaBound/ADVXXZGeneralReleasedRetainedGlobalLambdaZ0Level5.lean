...
theorem released_global_lambda_level5_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR0 5 = releasedGlobalLambdaWeightedLevel5NatsR0 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level5_weighted_nats_r0
