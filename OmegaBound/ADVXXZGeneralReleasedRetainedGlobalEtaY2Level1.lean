...
theorem released_global_eta_level1_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR2 1 = releasedGlobalEtaWeightedLevel1NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level1_weighted_nats_r2
