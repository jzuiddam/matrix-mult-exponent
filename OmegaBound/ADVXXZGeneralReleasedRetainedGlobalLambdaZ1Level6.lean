...
theorem released_global_lambda_level6_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR1 6 = releasedGlobalLambdaWeightedLevel6NatsR1 := by
  classical
  unfold releasedGlobalLambdaMixRowsR1 releasedLogicalAlphaYZ releasedLogicalBetaYZ
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level6_weighted_nats_r1
