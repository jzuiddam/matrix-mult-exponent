...
theorem released_global_lambda_level2_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR5 2 = releasedGlobalLambdaWeightedLevel2NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level2_weighted_nats_r5
