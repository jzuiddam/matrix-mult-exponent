...
theorem released_global_lambda_level3_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR5 3 = releasedGlobalLambdaWeightedLevel3NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level3_weighted_nats_r5
