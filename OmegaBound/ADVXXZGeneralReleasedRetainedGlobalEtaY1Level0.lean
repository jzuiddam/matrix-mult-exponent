...
theorem released_global_eta_level0_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR1 0 = releasedGlobalEtaWeightedLevel0NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level0_weighted_nats_r1
