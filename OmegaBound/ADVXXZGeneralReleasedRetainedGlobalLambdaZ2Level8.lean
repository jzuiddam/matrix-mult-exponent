...
theorem released_global_lambda_level8_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR2 8 = releasedGlobalLambdaWeightedLevel8NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level8_weighted_nats_r2
