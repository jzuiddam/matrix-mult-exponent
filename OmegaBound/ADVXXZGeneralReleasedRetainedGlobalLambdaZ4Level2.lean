...
theorem released_global_lambda_level2_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR4 2 = releasedGlobalLambdaWeightedLevel2NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level2_weighted_nats_r4
