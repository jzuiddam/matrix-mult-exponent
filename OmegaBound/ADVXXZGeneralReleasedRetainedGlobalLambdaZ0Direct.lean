import OmegaBound.ADVXXZGeneralReleasedRetainedGlobalLambdaZ0Data
...
theorem released_global_lambda_direct_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalLambdaDirectRowsR0 = releasedGlobalLambdaWeightedDirectNatsR0 := by
  classical
  unfold releasedGlobalLambdaDirectRowsR0 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalLambdaWeightedDirectNatsR0
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_direct_weighted_nats_r0
