import OmegaBound.ADVXXZGeneralReleasedRetainedGlobalEtaY3Data
...
theorem released_global_eta_direct_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalEtaDirectRowsR3 = releasedGlobalEtaWeightedDirectNatsR3 := by
  classical
  unfold releasedGlobalEtaDirectRowsR3 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalEtaWeightedDirectNatsR3
  ...
  simp
  all_goals norm_eta_y3_rows
  all_goals ring

end OmegaBound.ADVXXZGeneral

#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_direct_weighted_nats_r3
