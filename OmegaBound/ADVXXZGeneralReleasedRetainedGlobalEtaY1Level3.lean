...
theorem released_global_eta_level3_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR1 3 = releasedGlobalEtaWeightedLevel3NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level3_weighted_nats_r1
