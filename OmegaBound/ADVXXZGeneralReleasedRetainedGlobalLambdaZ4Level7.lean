...
theorem released_global_lambda_level7_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR4 7 = releasedGlobalLambdaWeightedLevel7NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level7_weighted_nats_r4
