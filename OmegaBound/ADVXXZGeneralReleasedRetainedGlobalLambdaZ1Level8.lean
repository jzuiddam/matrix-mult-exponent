...
theorem released_global_lambda_level8_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR1 8 = releasedGlobalLambdaWeightedLevel8NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level8_weighted_nats_r1
