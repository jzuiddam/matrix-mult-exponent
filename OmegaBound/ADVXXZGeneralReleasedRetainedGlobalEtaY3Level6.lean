...
theorem released_global_eta_level6_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR3 6 = releasedGlobalEtaWeightedLevel6NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level6_weighted_nats_r3
