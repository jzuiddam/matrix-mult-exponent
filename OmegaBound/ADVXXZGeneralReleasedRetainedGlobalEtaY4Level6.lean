...
theorem released_global_eta_level6_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR4 6 = releasedGlobalEtaWeightedLevel6NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level6_weighted_nats_r4
