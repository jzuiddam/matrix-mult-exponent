...
theorem released_global_lambda_level7_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR0 7 = releasedGlobalLambdaWeightedLevel7NatsR0 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level7_weighted_nats_r0
