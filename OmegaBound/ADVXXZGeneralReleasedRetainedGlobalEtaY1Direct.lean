import OmegaBound.ADVXXZGeneralReleasedRetainedGlobalEtaY1Data
...
theorem released_global_eta_direct_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalEtaDirectRowsR1 = releasedGlobalEtaWeightedDirectNatsR1 := by
  classical
  unfold releasedGlobalEtaDirectRowsR1 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalEtaWeightedDirectNatsR1
  ...
  simp
  all_goals norm_eta_y1_rows
  all_goals ring

end OmegaBound.ADVXXZGeneral

#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_direct_weighted_nats_r1
