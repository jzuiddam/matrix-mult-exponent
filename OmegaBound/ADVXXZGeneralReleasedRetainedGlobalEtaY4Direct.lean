...
theorem released_global_eta_direct_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalEtaDirectRowsR4 = releasedGlobalEtaWeightedDirectNatsR4 := by
  classical
  unfold releasedGlobalEtaDirectRowsR4 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalEtaWeightedDirectNatsR4
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_direct_weighted_nats_r4
