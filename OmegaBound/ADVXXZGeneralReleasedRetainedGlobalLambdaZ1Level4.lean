...
theorem released_global_lambda_level4_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR1 4 = releasedGlobalLambdaWeightedLevel4NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level4_weighted_nats_r1
