...
theorem released_global_lambda_direct_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalLambdaDirectRowsR3 = releasedGlobalLambdaWeightedDirectNatsR3 := by
  classical
  unfold releasedGlobalLambdaDirectRowsR3 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalLambdaWeightedDirectNatsR3
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_direct_weighted_nats_r3
