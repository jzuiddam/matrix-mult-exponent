...
theorem released_global_eta_level7_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR2 7 = releasedGlobalEtaWeightedLevel7NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level7_weighted_nats_r2
