...
theorem released_global_lambda_level6_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR0 6 = releasedGlobalLambdaWeightedLevel6NatsR0 := by
  classical
  unfold releasedGlobalLambdaMixRowsR0 releasedLogicalAlphaYZ releasedLogicalBetaYZ
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level6_weighted_nats_r0
