...
theorem released_global_lambda_level8_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR4 8 = releasedGlobalLambdaWeightedLevel8NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level8_weighted_nats_r4
