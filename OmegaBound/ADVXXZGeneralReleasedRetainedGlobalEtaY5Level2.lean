...
theorem released_global_eta_level2_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR5 2 = releasedGlobalEtaWeightedLevel2NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level2_weighted_nats_r5
