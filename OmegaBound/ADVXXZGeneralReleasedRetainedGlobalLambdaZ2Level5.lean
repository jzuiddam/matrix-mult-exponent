...
theorem released_global_lambda_level5_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR2 5 = releasedGlobalLambdaWeightedLevel5NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level5_weighted_nats_r2
