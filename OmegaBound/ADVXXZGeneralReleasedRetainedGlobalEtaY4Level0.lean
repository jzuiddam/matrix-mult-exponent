...
theorem released_global_eta_level0_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR4 0 = releasedGlobalEtaWeightedLevel0NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level0_weighted_nats_r4
