...
theorem released_global_eta_level0_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR3 0 = releasedGlobalEtaWeightedLevel0NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level0_weighted_nats_r3
