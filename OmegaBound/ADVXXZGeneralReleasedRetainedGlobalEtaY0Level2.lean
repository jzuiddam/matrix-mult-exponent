...
theorem released_global_eta_level2_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR0 2 = releasedGlobalEtaWeightedLevel2NatsR0 := by
  classical
  unfold releasedGlobalEtaMixRowsR0 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalEtaWeightedLevel2NatsR0
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level2_weighted_nats_r0
