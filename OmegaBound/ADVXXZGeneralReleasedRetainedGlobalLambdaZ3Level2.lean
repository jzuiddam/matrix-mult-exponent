...
theorem released_global_lambda_level2_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR3 2 = releasedGlobalLambdaWeightedLevel2NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level2_weighted_nats_r3
