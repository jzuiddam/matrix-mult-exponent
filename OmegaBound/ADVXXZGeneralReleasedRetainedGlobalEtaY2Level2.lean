...
theorem released_global_eta_level2_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR2 2 = releasedGlobalEtaWeightedLevel2NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level2_weighted_nats_r2
