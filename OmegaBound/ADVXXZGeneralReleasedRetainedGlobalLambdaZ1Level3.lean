...
theorem released_global_lambda_level3_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR1 3 = releasedGlobalLambdaWeightedLevel3NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level3_weighted_nats_r1
