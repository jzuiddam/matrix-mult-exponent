...
theorem released_global_eta_level1_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR1 1 = releasedGlobalEtaWeightedLevel1NatsR1 := by
  classical
  unfold releasedGlobalEtaMixRowsR1 releasedLogicalAlphaYZ releasedLogicalBetaYZ
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level1_weighted_nats_r1
