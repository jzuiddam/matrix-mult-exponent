...
theorem released_global_eta_level8_weighted_nats_r1 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR1 8 = releasedGlobalEtaWeightedLevel8NatsR1 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level8_weighted_nats_r1
