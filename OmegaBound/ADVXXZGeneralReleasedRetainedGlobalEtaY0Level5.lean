...
theorem released_global_eta_level5_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR0 5 = releasedGlobalEtaWeightedLevel5NatsR0 := by
  classical
  unfold releasedGlobalEtaMixRowsR0 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalEtaWeightedLevel5NatsR0
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level5_weighted_nats_r0
