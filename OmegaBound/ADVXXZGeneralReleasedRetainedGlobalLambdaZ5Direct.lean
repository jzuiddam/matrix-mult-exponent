import OmegaBound.ADVXXZGeneralReleasedRetainedGlobalLambdaZ5Data
...
theorem released_global_lambda_direct_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalLambdaDirectRowsR5 = releasedGlobalLambdaWeightedDirectNatsR5 := by
  classical
  unfold releasedGlobalLambdaDirectRowsR5 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalLambdaWeightedDirectNatsR5
  ...
  simp (config := { maxSteps := 10000000 }) only [
    ...
    OmegaBound.ADVXXZR5CertificateSplitData.certificateSplitByIndex]
  simp
  all_goals norm_lambda_z5_rows
  all_goals ring

end OmegaBound.ADVXXZGeneral

#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_direct_weighted_nats_r5
