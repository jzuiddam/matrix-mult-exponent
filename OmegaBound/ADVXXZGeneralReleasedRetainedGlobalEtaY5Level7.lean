...
theorem released_global_eta_level7_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR5 7 = releasedGlobalEtaWeightedLevel7NatsR5 := by
  classical
  unfold releasedGlobalEtaMixRowsR5 releasedLogicalAlphaYZ releasedLogicalBetaYZ
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level7_weighted_nats_r5
