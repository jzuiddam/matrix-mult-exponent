...
theorem released_global_lambda_level0_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR5 0 = releasedGlobalLambdaWeightedLevel0NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level0_weighted_nats_r5
