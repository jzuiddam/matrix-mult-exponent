import OmegaBound.ADVXXZGeneralReleasedRetainedGlobalEtaY2Data
...
theorem released_global_eta_direct_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalEtaDirectRowsR2 = releasedGlobalEtaWeightedDirectNatsR2 := by
  classical
  unfold releasedGlobalEtaDirectRowsR2 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalEtaWeightedDirectNatsR2
  ...
  simp
  all_goals norm_eta_y2_rows
  all_goals ring

end OmegaBound.ADVXXZGeneral

#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_direct_weighted_nats_r2
