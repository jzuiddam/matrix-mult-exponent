...
theorem released_global_lambda_level1_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR4 1 = releasedGlobalLambdaWeightedLevel1NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level1_weighted_nats_r4
