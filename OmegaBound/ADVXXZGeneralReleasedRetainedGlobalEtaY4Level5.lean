...
theorem released_global_eta_level5_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR4 5 = releasedGlobalEtaWeightedLevel5NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level5_weighted_nats_r4
