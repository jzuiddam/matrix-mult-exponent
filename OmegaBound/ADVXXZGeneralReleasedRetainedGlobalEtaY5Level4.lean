...
theorem released_global_eta_level4_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR5 4 = releasedGlobalEtaWeightedLevel4NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level4_weighted_nats_r5
