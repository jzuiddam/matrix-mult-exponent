...
theorem released_global_eta_level3_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR3 3 = releasedGlobalEtaWeightedLevel3NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level3_weighted_nats_r3
