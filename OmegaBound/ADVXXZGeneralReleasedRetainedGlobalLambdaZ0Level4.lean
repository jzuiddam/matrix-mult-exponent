...
theorem released_global_lambda_level4_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR0 4 = releasedGlobalLambdaWeightedLevel4NatsR0 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level4_weighted_nats_r0
