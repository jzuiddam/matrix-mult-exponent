...
theorem released_global_lambda_level1_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR5 1 = releasedGlobalLambdaWeightedLevel1NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level1_weighted_nats_r5
