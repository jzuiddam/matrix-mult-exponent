...
theorem released_global_lambda_level0_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR4 0 = releasedGlobalLambdaWeightedLevel0NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level0_weighted_nats_r4
