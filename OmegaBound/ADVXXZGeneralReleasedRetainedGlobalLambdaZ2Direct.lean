...
theorem released_global_lambda_direct_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalLambdaDirectRowsR2 = releasedGlobalLambdaWeightedDirectNatsR2 := by
  classical
  unfold releasedGlobalLambdaDirectRowsR2 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalLambdaWeightedDirectNatsR2
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_direct_weighted_nats_r2
