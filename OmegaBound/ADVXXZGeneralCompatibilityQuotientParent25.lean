...
private theorem compatibility_jointP_parent25_pos {w s b : ℕ}
    ...
    (hb : StepIntegralAt p d b) (ε : ℚ) (m : ℕ) (r : Fin 6) (W : Fin 2)
...
theorem compatibility_quotient_parent25 {w s b : ℕ} (p : ConstituentInput w s)
    (d : ConstituentSpec p) (hd : ConstituentAdmissibleAt d b)
    (hb : StepIntegralAt p d b) (ε : ℚ) (m : ℕ) (r : Fin 6) (W : Fin 2)
    (β : RepresentedLaw p d b ε m r W) :
  ...
  constructor
  · exact compatibility_jointP_parent25_pos p d hd hb ε m r W β
  · classical
...
theorem parent25_alphaLabel_target_count {w s b m : ℕ}
    (p : ConstituentInput w s) (d : ConstituentSpec p) (r : Fin 6)
    (J : AlphaLabel p d b m r) (t : Fin s) (u : ChildShape p t) :
...
theorem parent25_alphaLabel_complementary {w s b m : ℕ}
    (p : ConstituentInput w s) (d : ConstituentSpec p) (r : Fin 6)
    (J : AlphaLabel p d b m r) (t : Fin s)
...
theorem parent25_representedLaw_witness {w s b : ℕ}
