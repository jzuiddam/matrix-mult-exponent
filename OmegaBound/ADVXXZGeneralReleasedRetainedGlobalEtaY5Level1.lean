...
theorem released_global_eta_level1_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR5 1 = releasedGlobalEtaWeightedLevel1NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level1_weighted_nats_r5
