...
theorem released_global_eta_level1_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR4 1 = releasedGlobalEtaWeightedLevel1NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level1_weighted_nats_r4
