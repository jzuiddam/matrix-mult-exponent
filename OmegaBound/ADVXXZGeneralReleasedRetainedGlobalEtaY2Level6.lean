...
theorem released_global_eta_level6_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR2 6 = releasedGlobalEtaWeightedLevel6NatsR2 := by
  classical
  unfold releasedGlobalEtaMixRowsR2 releasedLogicalAlphaYZ releasedLogicalBetaYZ
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level6_weighted_nats_r2
