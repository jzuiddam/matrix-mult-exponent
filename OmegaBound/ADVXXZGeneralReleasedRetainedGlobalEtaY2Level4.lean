...
theorem released_global_eta_level4_weighted_nats_r2 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR2 4 = releasedGlobalEtaWeightedLevel4NatsR2 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level4_weighted_nats_r2
