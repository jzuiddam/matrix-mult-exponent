...
theorem released_global_lambda_level6_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR5 6 = releasedGlobalLambdaWeightedLevel6NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level6_weighted_nats_r5
