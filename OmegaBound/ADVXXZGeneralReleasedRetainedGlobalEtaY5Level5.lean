...
theorem released_global_eta_level5_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR5 5 = releasedGlobalEtaWeightedLevel5NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level5_weighted_nats_r5
