...
theorem released_global_eta_level6_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR5 6 = releasedGlobalEtaWeightedLevel6NatsR5 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level6_weighted_nats_r5
