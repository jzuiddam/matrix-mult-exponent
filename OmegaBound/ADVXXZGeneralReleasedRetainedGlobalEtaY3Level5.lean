...
theorem released_global_eta_level5_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR3 5 = releasedGlobalEtaWeightedLevel5NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level5_weighted_nats_r3
