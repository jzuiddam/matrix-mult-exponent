...
theorem released_global_lambda_level4_weighted_nats_r5 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR5 4 = releasedGlobalLambdaWeightedLevel4NatsR5 := by
  classical
  unfold releasedGlobalLambdaMixRowsR5 releasedLogicalAlphaYZ releasedLogicalBetaYZ
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level4_weighted_nats_r5
