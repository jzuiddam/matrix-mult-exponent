...
theorem released_global_eta_level1_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR3 1 = releasedGlobalEtaWeightedLevel1NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level1_weighted_nats_r3
