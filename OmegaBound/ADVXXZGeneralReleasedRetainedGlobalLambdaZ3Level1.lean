...
theorem released_global_lambda_level1_weighted_nats_r3 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR3 1 = releasedGlobalLambdaWeightedLevel1NatsR3 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level1_weighted_nats_r3
