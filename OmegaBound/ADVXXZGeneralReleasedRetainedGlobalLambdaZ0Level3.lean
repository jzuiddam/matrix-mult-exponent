...
theorem released_global_lambda_level3_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR0 3 = releasedGlobalLambdaWeightedLevel3NatsR0 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level3_weighted_nats_r0
