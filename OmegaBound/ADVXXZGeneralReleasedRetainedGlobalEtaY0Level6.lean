...
theorem released_global_eta_level6_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR0 6 = releasedGlobalEtaWeightedLevel6NatsR0 := by
  classical
  unfold releasedGlobalEtaMixRowsR0 releasedLogicalAlphaYZ releasedLogicalBetaYZ
    releasedGlobalEtaWeightedLevel6NatsR0
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level6_weighted_nats_r0
