...
theorem released_global_lambda_level0_weighted_nats_r0 :
    (1 : ℝ) / 6 * releasedGlobalLambdaMixRowsR0 0 = releasedGlobalLambdaWeightedLevel0NatsR0 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_lambda_level0_weighted_nats_r0
