...
theorem released_global_eta_level7_weighted_nats_r4 :
    (1 : ℝ) / 6 * releasedGlobalEtaMixRowsR4 7 = releasedGlobalEtaWeightedLevel7NatsR4 := by
  classical
...
#print axioms OmegaBound.ADVXXZGeneral.released_global_eta_level7_weighted_nats_r4
